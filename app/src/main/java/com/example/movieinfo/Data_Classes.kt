...
data class movie(var adult:Boolean=false,var backdrop_path:String="empty",var budget:Long=100,var homepage:String="Empty", var id:Int=0,var imdb_id:String, var original_language:String , var original_title:String,var overview:String="empty",var poster_path:String="empty",var status:String="empty",var tagline:String="empty",var title:String="empty",var vote_average:Float=10.00f, var release_date:String){
